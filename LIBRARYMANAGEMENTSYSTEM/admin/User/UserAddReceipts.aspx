<%@ Page Title="" Language="C#" MasterPageFile="~/admin/User/UserDashboard.Master" AutoEventWireup="true" CodeBehind="UserAddReceipts.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.User.UserAddReceipts" %>
                                    ...
                                    <div class="card-body custom-edit-service">
                                        <div class="service-fields mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <%-- <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <asp:RadioButtonList ID="rbtnPaymentType" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbtnPaymentType_SelectedIndexChanged" CssClass="chkChoice myCheckBoxList">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="submit-section">
                                                            <asp:Button Text="Payment" runat="server" class="btn btn-primary submit-btn" ID="btn_submit" OnClick="btn_submit_Click" />
