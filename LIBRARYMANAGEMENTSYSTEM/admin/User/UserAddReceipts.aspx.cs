...
{
    public partial class UserAddReceipts : System.Web.UI.Page
    {
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objReceiptDetails.memberID = Session["MemberID"].ToString();
                objReceiptDetails.memberName = Session["AdvocateName"].ToString();
                objReceiptDetails.paymentType = "Online";
                ...
                objReceiptDetails.towards = "";
                objReceiptDetails.transactionID = "";
                ...
                objpayment.PaymentIntiationpage = "Donation Receipt";
                ...
                Session["objReceiptDetails"] = objReceiptDetails;
                Session["objpayment"] = objpayment;
                Session["MembershipName"] = Session["AdvocateName"].ToString();
                Session["Membershipmobilenumber"] = Session["MobileNumber"].ToString();
                Session["MembershipEmailID"] = Session["Email"].ToString();
                Session["MembershiptypeName"] = "Receipt";
                Session["membershipfee"] = txtAmount.Text;
                Session["PageIntiateforpayment"] = "Donation Receipt";
