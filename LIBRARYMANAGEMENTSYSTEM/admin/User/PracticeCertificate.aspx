<%@ Page Title="" Language="C#" MasterPageFile="~/admin/User/UserDashboard.Master" AutoEventWireup="true" CodeBehind="PracticeCertificate.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.User.PracticeCertificate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="col-md-7 col-lg-8 col-xl-9" data-select2-id="9">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Practice Certificate Request</h3>
        ...
        <div class="card" data-select2-id="8">
            <div class="card-body" data-select2-id="7">
                ...
                <p>Note: !Important for every new Practice Certificate Request charge of 200.</p>
