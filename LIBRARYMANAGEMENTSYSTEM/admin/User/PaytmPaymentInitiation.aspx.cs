    ...
    public partial class PaytmPaymentInitiation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
          //  Session["membershipfee"] = "1";
            ...
            {
                Session["Response"] = "";
                Session["mid"] = ConfigurationManager.AppSettings["paymentMid"].ToString();
            ...
            else if (time % 5 == 0)
            {
                ...
                */
                ...
                //For  Staging
                //string url1 = ConfigurationManager.AppSettings["stagingpaymentgatwayurlforqrstatus"].ToString();
                    ...
                    if (objResp != null)
                    {
                        if (objResp.body != null)
                        {
                            if (objResp.body.resultInfo != null)
                            {
                                ...
                                {
                                    Response.Redirect("UserPaymentConformation.aspx");
