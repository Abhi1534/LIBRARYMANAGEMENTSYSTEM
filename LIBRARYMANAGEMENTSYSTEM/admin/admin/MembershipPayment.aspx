<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MembershipPayment.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.admin.MembershipPayment" %>
            ...
            <td>
                <table width="640" align="center" border="0" cellpadding="0" cellspacing="0" class="table_wrapper">
                    ...
                    <tr>
                        ...
                        <td background="Images/BackgroundImage.jpg" style="background-size: cover; background-color: #fafafa;" valign="top">
                            <!--[if gte mso 9]>
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="0">
                                            <img src="Images/visa.png" alt="" height="1" width="1" /></td>
                                                                ...
                                                                <td width="240">
                                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td width="20">
                                                                                <img src="images/blank.gif" alt="" height="1" width="1" /></td>
                                                        ...
                                                        <table width="240" height="42" cellpadding="0" cellspacing="0" border="0" style="border-radius: 5px;">
                                                            <tr>
                                                                <td height="42" align="center">
                                                                    <form action="../PaymentConformation.aspx?oid=<%=baseid%>" method="post">
                            ...
                            <table width="100%">
                                <tr>
                                    <td height="20 ">
                                        ...
                                        <img src="Images/logo_1.png" alt="" height="1" width="1"></td>
                                </tr>
                                <tr>
                                    <td>
                                        <table width="100%">
