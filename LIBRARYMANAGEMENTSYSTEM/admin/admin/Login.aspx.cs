...
namespace LIBRARYMANAGEMENTSYSTEM.admin.admin
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btn_login_Click(object sender, EventArgs e)
        {
            ...
            Session["UserDetails"] = txt_Mobilenumber.Text + "," + txt_password.Text;
            LMBAL bal = new LMBAL();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                if (ds.Tables[0].Rows[0]["RoleID"] != null && !string.IsNullOrWhiteSpace(ds.Tables[0].Rows[0]["RoleID"].ToString()))
                {
                    ...
                    if (ds.Tables[0].Rows[0]["RoleID"].ToString() == "4")
                    {
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('This UserID not Authorized to login..!')", true);
        ...
        protected void message(string otp)
        {
            string sAPIKey = "rUmg2YSTEkSvPaN3SKxu5A";
            ...
            Session["ValidateMobilenumber"] = txt_Mobilenumber.Text;
            Session["Loginotp"] = otp;
            string sMessage = "Dear User,Your OTP for login portal is '" + otp.ToString() + "'. Please do not share this OTP.Regards,EV-NREDCAP";
