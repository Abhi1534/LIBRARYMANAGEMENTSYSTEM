...
{
    public partial class StampInvoiceView : System.Web.UI.Page
    {
        ...
        public void binddetail()
        {
            ...
            if (Session["PageIntiateforpayment"].ToString() == "WelfareStamps" || Session["PageIntiateforpayment"].ToString() == "CourtStamps")
            {
        ...
        public void barcodegenrator()
        {
            ...
            //string bookserialno = Session["Invoicenumber"].ToString();
            //string barCodeData = Session["Invoicenumber"].ToString();
