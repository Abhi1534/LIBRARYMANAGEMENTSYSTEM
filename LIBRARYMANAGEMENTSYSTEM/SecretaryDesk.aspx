<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecretaryDesk.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.SecretaryDesk" %>
                    ...
                    <div class="col-lg-12">
                        <div class="blog-details mt-80">
                            ...
                            <div class="cont">
                                ...
                                <p>
                                    Welcome you to the website of Telangana High Court Advocates' Association.
    It gives me immense delight to note that the Telangana High Advocates' Association (2017 - 2018) has collectively taken steps to setting up a website.
     In today's world connect creativity with technology is the key to success, and I am sure that this website would serve the vital purpose; 
    Telangana High Court Advocates' Association website definitely handy in the sense that the information that it contains can be 
    easily accessed at the touch of a button. In this website we also gave an edit option to change the portfolio with certain security.
     Our High Court Premise is connected with wi-fi and with which I look forward to maximum utilization of this website by our 
    Telangana High Court Advocates' Association members. I also welcome your suggestions and comments.
                                </p>
