<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="MembershipDetails.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.MembershipDetails" %>
...
<body>
    ...
    <form id="form1" runat="server">
      ...
      <header id="header-part">
        ...
        <br />
        <br />
        <section id="teachers-part" style="padding-top: 190px">
            <%--class="pt-280 pb-120"--%>
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
