<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gallerylatest.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.Gallerylatest" %>
                                ...
                                <div class="photo-gallery">
                                    <div class="container">
                                        ...
                                        <div class="row photos">
                                            <asp:Repeater runat="server" ID="rpt_gallerylatest">
                                                <ItemTemplate>
                                                    <div class="col-sm-6 col-md-4 col-lg-3 item">
                                                        <a href='<%# Eval("ImagePath")%>' data-lightbox="photos">
                                                            <div class="lb-details"><span class="lb-caption" style="display: none;"></span><span class="lb-number1"></span></div>
                                                            <img class="img-fluid" src='<%# Eval("ImagePath")%>'></a>
