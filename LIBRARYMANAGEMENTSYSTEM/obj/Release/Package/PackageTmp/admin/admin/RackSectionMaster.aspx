<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin/AdminDashboard.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="RackSectionMaster.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.admin.RackSectionMaster" %>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Section Master</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="service-fields mb-3">
                                <asp:Panel runat="server" ID="pnl_entry" Visible="false">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" class="form-control" ID="txt_Sectionname" required="" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="submit-section">
                                        <asp:Button Text="Submit" runat="server" ID="btn_submit" class="btn btn-primary submit-btn" OnClick="btn_submit_Click" />
                                            ...
                                            <asp:GridView ID="grid_data" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" AllowSorting="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Section ID" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_SectionID" runat="server" Text='<%# Eval("SecMID")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" CommandName="Btn_EditCommand" ID="btn_Edit" CommandArgument='<%# Eval("SecMID")%>'><asp:image imageurl="Images/edit.svg" runat="server" Height="20px" Width="20px" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
