<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.admin.Expenses" %>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtExpenseName" class="form-control" runat="server" required=""></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label>Amount<span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtAmount" class="form-control" runat="server" TextMode="Number" required=""></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
