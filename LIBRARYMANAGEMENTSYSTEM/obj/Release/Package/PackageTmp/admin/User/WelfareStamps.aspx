<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="WelfareStamps.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.User.WelfareStamps" %>
                                ...
                                <div class="col-md-6 col-6">
                                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Welfare Stamps</li>
                                        </ol>
                                    </nav>
                                    ...
                                    <div class="card">
                                        <div class="card-body" data-select2-id="7">
                                            ...
                                            <div class="page-header">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <h3 class="page-title">Welfare Stamps</h3>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:TextBox runat="server" class="form-control" pattern="[7-9]{1}[0-9]{9}" ID="txt_MobileNumber" required="" />
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                                <label>Number Of Stamps (1 * 100)<span class="text-danger"> *</span></label>
                                                                                <asp:TextBox runat="server" class="form-control" ID="txt_numberofstamps" TextMode="Number" required="" AutoPostBack="true" OnTextChanged="txt_numberofstamps_TextChanged" />
