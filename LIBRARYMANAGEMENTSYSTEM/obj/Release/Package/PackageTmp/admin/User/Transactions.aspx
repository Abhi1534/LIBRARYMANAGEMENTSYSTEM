<%@ Page Title="" Language="C#" MasterPageFile="~/admin/User/UserDashboard.Master" AutoEventWireup="true" CodeBehind="Transactions.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.User.Transactions" %>
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        <asp:GridView ID="gdvLibartyStatus" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" AllowSorting="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Book Name" ItemStyle-CssClass="text">
                                ...
                                <asp:TemplateField HeaderText="Book Author" ItemStyle-CssClass="text">
                                    <ItemTemplate>
                                        <a href="profile.aspx" class="avatar avatar-sm mr-2">
                                            <img class="avatar-img rounded-circle" src="../assets/img/doctors/doctor-thumb-01.jpg" alt="User Image"></a>
                                ...
                                <asp:TemplateField HeaderText="No Of Books Issued" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAvailableBooks" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"NoOfBooksIssued")%>'> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="No Of Books Returnd" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAvailableBooks" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"NoOfBooksReturned")%>'> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Pending Books" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalBooks" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"PendingBooks")%>'> </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
