<%@ Page Title="" Language="C#" MasterPageFile="~/admin/User/UserDashboard.Master" AutoEventWireup="true" CodeBehind="ProximityCard.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.User.ProximityCard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="col-md-7 col-lg-8 col-xl-9" data-select2-id="9">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Proximity Card Request</h3>
        ...
        <div class="card" data-select2-id="8">
            <div class="card-body" data-select2-id="7">
                ...
                <p>Note: !Important for every new Proximity Card Request charge of 200.</p>
