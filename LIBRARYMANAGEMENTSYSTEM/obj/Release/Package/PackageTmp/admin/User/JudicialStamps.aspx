<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JudicialStamps.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.User.JudicialStamps" %>
                                ...
                                <div class="col-md-6 col-6">
                                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Non Judicial Stamps</li>
                                        </ol>
                                    </nav>
                                    ...
                                    <div class="card">
                                        <div class="card-body" data-select2-id="7">
                                            ...
                                            <div class="page-header">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <h3 class="page-title">Non Judicial Stamps</h3>
                                                        ...
                                                        <div class="card-body custom-edit-service">
                                                            ...
                                                            <div class="service-fields mb-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label>Name On Stamp Paper<span class="text-danger">*</span></label>
                                                                            <asp:TextBox runat="server" class="form-control" ID="txt_nameonstamppaper" required="" />
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <asp:TextBox runat="server" class="form-control" ID="txt_residenceaddress" required="" />
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <asp:DropDownList runat="server" class="form-control select" ID="ddl_stamptype">
                                                                                ...
                                                                                <asp:ListItem Text="20" Value="1" />
                                                                                <asp:ListItem Text="50" Value="2" />
                                                                                <asp:ListItem Text="100" Value="3" />
                                                                            </asp:DropDownList>
