<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonationOther.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.admin.User.DonationOther" %>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:TextBox runat="server" class="form-control" pattern="[^ @]*@[^ @]*" ID="txt_email" required="" />
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:TextBox runat="server" class="form-control" ID="txt_price" required="" />
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:TextBox runat="server" class="form-control" ID="txt_Description" required="" />
