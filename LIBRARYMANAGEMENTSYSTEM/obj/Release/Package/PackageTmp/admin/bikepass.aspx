<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bikepass.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.bikepass" %>
...
.card {
  position: relative;
    ...
    width: 530px;
    margin: 0 auto;
    background: url(images/bikepassbg.png);
    border-radius: 4px;
...
<div class='card'>
  ...
  <article>
    ...
    <div class='area'>
      ...
      <ul>
        <li><span class="boldarea"> S. SHARAVAN KUMAR</span>
        </li>
        <li><span class="boldarea"> TS 16 ER 5151</span>
        </li>
          <li>
        <span class="boldarea"> 9032014151</span>
          </li>
           <li>
        <span class="boldarea"> A +ve</span>
          </li>
          <li>
              <span class="role">LIFE</span>
          </li>
      </ul>
    </div>
  </article>
