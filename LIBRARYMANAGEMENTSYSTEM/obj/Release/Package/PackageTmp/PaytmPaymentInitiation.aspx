<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaytmPaymentInitiation.aspx.cs" Inherits="LIBRARYMANAGEMENTSYSTEM.PaytmPaymentInitiation" %>
...
<body>
    ...
    <div style="padding:50px; background-image: url(images/Paytm2.png); background-repeat: no-repeat; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
        <div class="main-wrapper" style="text-align: center; border: 2px solid blue; background-color: white; object-fit: cover">
...
<body>
    <script type="application/javascript" src="https://securegw-stage.paytm.in/paymentservices/qr/create/merchantpgpui/checkoutjs/merchants/TELANG38998201047460.js" onload="onScriptLoad();" crossorigin="anonymous"></script>
    <script>
